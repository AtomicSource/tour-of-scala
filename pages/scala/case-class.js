...
const mainInfoBox = <>
  <p>We learned about <code>class</code> in a previous SKB, today we are going to learn about <code>case class</code>. They serve the same purpose which is to provide a blueprint to create <code>object</code>s. But a case class provides a lot of built-in advantages.</p>
...
const detailedInfoBox = <>
  ...
  <p>In Scala, a <code>case class</code> provides built-in things, let's go over them:
  </p><ul>
    ...
    <li>Field accessors: in <code>case class</code>, the fields are <code>public</code> ( we are going to talk about <code>visibility</code> later ) by default. So you can access their values without the need for a method that returns it for you.</li>
