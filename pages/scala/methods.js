...
const mainInfoBox = <>
  <p>A method in a programming language is a bit of code that gets executed when called and returns a value.</p>
...
const detailedInfoBox = <>
  ...
  <p>One main thing to note, if the method does not take arguments, you do not need the <code>(...)</code>, the parentheses are optional.</p>
  <p>In practice, you have to be careful when calling a method. Be sure to use parentheses when it was defined with them. And don't use parentheses when the method was defined without them.</p>
</>
